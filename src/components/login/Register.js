...
const Register = ({
    ...
    return (
        <>
            {
                paneluser ?
                    <UserPanel setFormLoginShow={setFormLoginShow} setFormRegisterShow={setFormRegisterShow}
                               setPaneluser={setPaneluser} loggedin={loggedin} seteditInformation={seteditInformation}/>
                    :
                    <>
                        <button class="btn btn-primary" onClick={s => {
                            setFormLoginShow(false);
                            setFormRegisterShow(false)
                        }}>Home
                        </button>
